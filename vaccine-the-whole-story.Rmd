---
title: "Pakistan: More Fun With Covid019 Vaccine"
author: "David Jackson"
date: "6/292021 10:45 AM/EDT"
...
df <- dbGetQuery(db,"select * from OWID where location ='Pakistan'")
...
ggplot(df) + geom_line(aes(x=date,y=total_vaccinations)) +
  ...
  labs(title="Pakistan total vaccinations Doses by Date",
...
ggplot(df) + geom_line(aes(x=date,y=people_vaccinated)) +
  scale_y_continuous(labels = comma) +
  labs(title="Pakistan Total People Vaccinated To Date",
...
ggplot(df) + geom_line(aes(x=date,y=people_fully_vaccinated)) +
  scale_y_continuous(labels = comma) +
  labs(title="Pakistan Total People Fully  Vaccinated To Date",
...
ggplot(df) + geom_line(aes(x=date,y=new_vaccinations)) +
  scale_y_continuous(labels = comma) +
  labs(title="Pakistan Daily People  Vaccinated by Date",
...
ggplot(df) + geom_line(aes(x=date,y=new_vaccinations_smoothed)) +
  scale_y_continuous(labels = comma) +
  labs(title="Pakistan Daily People  Vaccinated by Date",y="Daily Vaccinations (Smooth)",
...
ggplot(df) + geom_line(aes(x=date,y=total_vaccinations_per_hundred)) +
  scale_y_continuous(labels = comma) +
  labs(title="Pakistan Total Vaccinations Per Hundred",y="Daily Vaccinations (Per 100 People)",
...
ggplot(df) + geom_line(aes(x=date,y=people_vaccinated_per_hundred)) +
  scale_y_continuous(labels = comma) +
  labs(title="Pakistan People Vaccinated Per Hundred",y="People Vaccinated (per 100)",
...
ggplot(df) + geom_line(aes(x=date,y=people_fully_vaccinated_per_hundred)) +
  scale_y_continuous(labels = comma) +
  labs(title="Pakistan People Fully Vaccinated Per Hundred",y="People Vaccinated (per 100)",
